    ...
    <main className="min-h-screen bg-white text-black px-6 py-16">
      ...
      <section className="max-w-4xl mx-auto mt-24">
        ...
        <h2 className="text-3xl font-bold">
          How TikTok Live ROI Works
        </h2>

        <p className="mt-6 text-gray-700 leading-8">
        TikTok Live sellers in Indonesia need to calculate
        streaming ROI carefully before scaling campaigns.

        Many live sellers underestimate creator commissions,
        ads costs and shipping expenses, leading to negative ROI.
        </p>
        ...
        <div className="mt-10 space-y-8">
          ...
          <div>
            <h3 className="text-xl font-semibold">
              What is a good TikTok Live ROI?
            </h3>
          ...
          <div>
            <h3 className="text-xl font-semibold">
              How can live sellers improve ROI?
            </h3>
