...
export default function Calculator() {
    ...
    <main className="min-h-screen bg-white text-black px-6 py-16">
      ...
      <section className="max-w-4xl mx-auto mt-24">
        ...
        <h2 className="text-3xl font-bold">
         How TikTok Shop Profit Works
        </h2>

        <p className="mt-6 text-gray-700 leading-8">
         TikTok Shop sellers in Indonesia need to calculate
         real profit after shipping, affiliate commissions,
         ads costs and platform fees.

          Many sellers focus only on revenue while ignoring
      ...
      How do TikTok Shop sellers calculate profit?
      </h3>

    <p className="mt-2 text-gray-600">
      Sellers calculate profit by subtracting product cost,
      shipping fees, affiliate commissions and advertising
  ...
  <div>
    ...
    <p className="mt-2 text-gray-600">
      Many successful TikTok Shop sellers target profit
      margins above 20% to maintain sustainable growth.
    </p>
  </div>
  ...
  <div className="grid md:grid-cols-2 gap-6 mt-10">
    ...
    >
      ...
      <p className="mt-4 text-gray-600">
        Calculate TikTok Shop profit margins instantly.
      </p>
    </Link>
    ...
    >
      ...
      <p className="mt-4 text-gray-600">
        Estimate TikTok Shop seller fees and costs.
      </p>
    </Link>
